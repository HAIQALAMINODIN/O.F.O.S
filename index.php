...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/barbeque.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Welcome to </br><span style="color:#D2691E;">ORDER FOOD ONLINE SYSTEM</br>(O.F.O.S)</span></h1></br>
                    <h4 style="color:white;">"Click, Order, Savor: Bringing Flavor to Your Doorstep!"</h4>
                    ...
                    <!--<div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose a DISH</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>TOP DISHES</h2>
                    <p class="lead">Where the aroma of dishes dances through the air, welcoming you to taste the flavors of home.</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We've got your covered with menus from a variety of culture.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Order Food</h3>
                                <p>We provide you with food that is still hot</p>
                            </div>
                        </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                <li>
                                    <a href="#"> <img src="logopayment/fpx.png" alt="FPX"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="logopayment/tng.png" alt="TouncNgo"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="logopayment/boost.png" alt="Boost"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="logopayment/shopeepay.png" alt="ShopeePay"> </a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Bandar Sri Permaisuri, Kuala Lumpur</p>
                                    <h5>Phone: +03-123456789</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>The order food online system utilized integrates user-friendly interfaces and secure payment gateways, enhancing the overall customer experience and facilitating hassle-free transactions from browsing the menu to doorstep delivery.</p>
                        </div>
                    </div>
                </div>
